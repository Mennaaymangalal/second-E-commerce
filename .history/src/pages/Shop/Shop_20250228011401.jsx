  ...
  return (
    <>
      ...
      <footer className="py-6 bg-gray-200 text-gray-900">
        <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12">
          <div className="grid justify-center lg:justify-between">
            ...
            <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
              {["Email", "Twitter", "GitHub"].map((platform, index) => (
                <a key={index} href="#" title={platform} className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-500 hover:bg-blue-600 text-white">
                  {platform}
                </a>
              ))}
            </div>
