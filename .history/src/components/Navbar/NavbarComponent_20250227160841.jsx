...
export default function NavbarComponent() {
    ...
    const [isInDarkMode, setIsInDarkMode] = React.useState( window.matchMedia("(prefers-color-scheme: dark)").matches);
  ...
  return (
   ...
   <Navbar isBordered isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen}>
      ...
      <div onClick={darkMode} className="flex flex-col justify-center ml-3">
